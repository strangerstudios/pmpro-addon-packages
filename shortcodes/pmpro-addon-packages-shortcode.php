...
function pmpro_addon_packages_shortcode($atts, $content = null, $code = "")
{
    ...
    if (!empty($pmproap_posts)) {
        ?>
        <style>
            .pmpro_addon_package td {
                vertical-align: middle;
            }

            tr.pmpro_addon_package td.pmpro_addon_package-title h3 {
                margin: 0;
            }

            #pmpro_addon_packages h3.pmpro_addon_package-title {
                margin: 0 0 2rem 0;
            }

            .pmpro_addon_package td.pmpro_addon_package-thumbnail img {
                max-width: 100%;
                height: auto;
            }

            .pmpro_addon_package td.pmpro_addon_package-buy .pmpro_btn, .pmpro_addon_package td.pmpro_addon_package-view .pmpro_btn {
                display: block;
            }
        </style>
        <?php
        if ($layout == 'table') {
                ...
                foreach ($pmproap_posts as $post) {
                    ...
                    <tr id="pmpro_addon_package-<?php echo $post->ID; ?>" class="pmpro_addon_package">
                        ...
                        if (!empty($current_user->ID) && pmproap_hasAccess($current_user->ID, $post->ID)) {
                            ?>
                            <td width="25%" class="pmpro_addon_package-view"><a class="pmpro_btn"
                                                                                href="<?php echo the_permalink(); ?>"><?php echo $view_button; ?></a>
                            </td>
                            <?php
                        } else {
                            ...
                            <td width="25%" class="pmpro_addon_package-buy">
                                ...
                                if (empty($text_level_id)) {
                                    ...
                                    ?>
                                    <a class="pmpro_btn"
                                       href="<?php echo pmpro_url("checkout", "?level=" . $text_level_id . "&ap=" . $post->ID); ?>">
                                        <?php echo $checkout_button; ?> &mdash; <span
                                            class="pmpro_addon_package-price"><?php echo pmpro_formatPrice($pmproap_price); ?></span>
                                    </a>
                                    <?php
                                }
                                ?>
            ...
            <div id="pmpro_addon_packages">
                ...
                foreach ($pmproap_posts_chunks as $row): ?>
                    <div class="row">
                        ...
                        foreach ($row as $post):
                            ...
                            elseif ($layout == '4col')
                                ...
                                echo '12 '; ?>
								columns">
                                <article id="pmpro_addon_package-<?php echo $post->ID; ?>"
                                         class="<?php echo implode(" ", get_post_class()); ?> pmpro_addon_package">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        if (!empty($current_user->ID) && pmproap_hasAccess($current_user->ID, $post->ID)) {
                                            ?>
                                            <p class="pmpro_addon_package-view"><a class="pmpro_btn"
                                                                                   href="<?php echo the_permalink(); ?>"><?php echo $view_button; ?></a>
                                            </p>
                                            <?php
                                        } else {
                                            ...
                                            if (empty($text_level_id)) {
                                                ?>
                                                <p class="pmpro_addon_package-buy"><a class="pmpro_btn"
                                                                                      href="<?php echo pmpro_url("levels"); ?>"><?php echo $levels_button; ?></a>
                                                </p>
                                                <?php
                                            } else {
                                                //what's the price
                                                ...
                                                ?>
                                                <p class="pmpro_addon_package-buy"><a class="pmpro_btn"
                                                                                      href="<?php echo pmpro_url("checkout", "?level=" . $text_level_id . "&ap=" . $post->ID); ?>"><?php echo $checkout_button; ?> &mdash;
                                                        <span
                                                            class="pmpro_addon_package-price"><?php echo pmpro_formatPrice($pmproap_price); ?></span></a>
                                                </p>
                                                <?php
                                            }
                                        }
                    ...
                    <?php if ($layout == '3col' || $layout == '4col') {
                        echo "<hr />";
                    } ?>
                <?php endforeach; ?>
